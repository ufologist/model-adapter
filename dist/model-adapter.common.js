...
var enumOwnProps = _interopDefault(require('@fav/prop.enum-own-props'));
var isPlainObject = _interopDefault(require('@fav/type.is-plain-object'));
 ...
 * @param {object} [defaults] 源数据的默认值
 * @param {object} [propertyAdapter] 属性适配器: 结构为 `{propertyPath1: <adapter>, propertyPath2: <adapter>, ...}`
...
function ModelAdapter(source, defaults) {
  ...
  /**
   * @type {function} 新增/更新/删除属性适配器. 当传入的适配器为 null 时, 删除该适配器
   * @param {string} propertyPath
